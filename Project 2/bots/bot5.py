...
class Bot5(Bot):
    ...
    def find_nearest_cell(self):
        max_probability = self.leak_probability_grid.max() # max probability for any cell is 1 (since this probability matrix is binary, either contain or does not contain leak)
